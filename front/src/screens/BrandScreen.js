    ...
    <>
      {loading ? (
        ...
        <div className="container">
            <h1 className="title has-text-centered pt-4">{details.brandData.name}</h1>
            <div class="content">
            <h1>Description</h1>
            <p>{details.brandData.description} Lorem Ipsum is simply dummy text of the printing and typesetting industry.
